package com.example.demo.m5.config;

import com.example.demo.m5.service.InMemoryTaskTemplateRepository;
import com.example.demo.m5.service.TaskRearranger;
import com.example.demo.m5.service.TaskSelector;
import com.example.demo.m5.service.TaskTemplateRepository;
import org.springframework.boot.autoconfigure.condition.ConditionalOnMissingBean;
import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;

/**
 * M5 模块 Spring Boot 自动配置。
 *
 * <p>在主项目中引入此模块后，自动注册 TaskTemplateRepository、TaskSelector、TaskRearranger。
